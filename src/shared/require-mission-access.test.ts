...
function mockStore(
  ...
  return {
    ...
    createLesson: vi.fn(),
    getLesson: vi.fn(),
    getLatestLesson: vi.fn(),
    listLessons: vi.fn(),
    listLessonSummaries: vi.fn(),
    getMaxLessonNumber: vi.fn(),
    getSubLessonCount: vi.fn(),
    getLessonCount: vi.fn(),
    getMainLessonCount: vi.fn(),
    getLearningRecordCount: vi.fn(),
    findLessonBySlug: vi.fn(),
    updateLessonStatus: vi.fn(),
    updateLessonFeedback: vi.fn(),
    listLessonFeedback: vi.fn(),
    updateLessonContent: vi.fn(),
    createGuidedQuestion: vi.fn(),
    getPendingQuestion: vi.fn(),
    answerQuestion: vi.fn(),
    skipPendingQuestions: vi.fn(),
    createReferenceDoc: vi.fn(),
    getReferenceDoc: vi.fn(),
    listReferenceDocs: vi.fn(),
    createLearningRecord: vi.fn(),
    listLearningRecords: vi.fn(),
    updateLearningRecord: vi.fn(),
    getMissionContent: vi.fn(),
    upsertMissionContent: vi.fn(),
    getUser: vi.fn(),
